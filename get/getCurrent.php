<?php
	...
	$sql = "select distinct(batch) as batch from customers";
	...
	if ($result->num_rows > 0) {
  		while($row = $result->fetch_assoc()) {
    		...
    		$data=$data."<div class='services-block col-md-4 col-sm-6 col-xs-12' onclick='location.href=currentDetails.html;' style='cursor: hand;'>
                <div class='inner-box'>
                    <div class='upper-box'>
                        <div class='icon-box'><i class='fa fa-graduation-cap'></i><h3><a href='currentDetails.html?batch=".$row['batch']."'>Btc. ".$row['batch']."</a></h3></div>
                    </div>
